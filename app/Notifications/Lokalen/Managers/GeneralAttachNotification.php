...
/**
 * Class GeneralAttachNotification
 * 
 * @package App\Notifications\Lokalen\Managers
 */
class GeneralAttachNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(): array
    {
        return [
            'sender'        => $this->creator,
            'title'         => 'Aangewezen als algemeen verantwoordelijke',
            'message'       => "Je bent aangewezen als algemeen verantwoordelijke voor een lokaal. ({$this->lokaal->naam})",
