...
class CountryTableSeeder extends Seeder
{
    ...
    {
        foreach ($this->getCountries() as $alpha2code => $name) {
            Country::create(['alpha2code' => $alpha2code, 'name' => $name]);
        }
    }

    /**
     * The function, that defines all the countries that needs to be seeded. 
     * 
     * @return array
     */
